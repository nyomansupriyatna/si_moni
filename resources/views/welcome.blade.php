        ...
        <div class="relative flex justify-center min-h-screen py-4 bg-gray-100 items-top dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                    @auth
                        <a href="{{ route('logout') }}}" class="text-sm text-gray-700 underline dark:text-gray-500">Logout</a>
                    @else
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-6">
                            <div class="flex items-center justify-center text-center">
                                <h2>Sistem Informasi Monitoring Instalasi Pasang Baru Wifi ID PT Telkom Akses Witel Bali Selatan</h2>
                            </div>
                            ...
                            <div class="flex items-center justify-center text-center">
                                <h3>Menggunakan Laravel 8 Livewire</h3>
                            </div>
                        </div>
